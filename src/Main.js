    ...
    <div>
      <div className="background">
        ...
        <Menu right>
          ...
          <a id="my-resume" className="menu-item" href="/sahara-fathelbab-resume.pdf">My Resume</a>
      ...
      <About
        ...
        id_para2="project-paragraph"
        link="https://github.com/saharafathelbab/portfolio/tree/gh-pages/documentation/HarryPotterSnowmanDocumentation?"
      ...
      <div className="little-about-me">
        ...
        show= "no-show"
        link="/sahara-fathelbab-resume.pdf"
        name="My Resume"
        class="button-style"
        />
      </div>
